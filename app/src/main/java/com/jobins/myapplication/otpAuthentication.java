package com.jobins.myapplication;
...
public class otpAuthentication extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mprogressbarofotpauth= findViewById(R.id.progressbarauth);
        ...
        mverifyotp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(getApplicationContext(),"Enter Recieved OTP",Toast.LENGTH_SHORT ).show();
                }
                else
                {
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful())
                {
                    ...
                    Intent intent = new Intent(otpAuthentication.this,myprofile.class);
                    startActivity(intent);
                    finish();
                }
                else
